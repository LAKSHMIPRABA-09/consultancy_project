...
//         {/* Add more details such as reviews here */}
//       </div>
//     </div>
//   );
// }
...
import React from 'react';
// Import useParams to access URL params

const SingleProduct = () => {
  const { id } = useParams(); // Access the product ID from URL params
  const product = products.find(product => product.id === parseInt(id)); // Find the product based on ID
